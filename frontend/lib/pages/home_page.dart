        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const Spacer(flex: 2),
              ErrorInfo(
                title: "Hello and Welcome ${_sender!.name}",
                description:
                    "We're setting things up for you. This will only take a moment.",
                button: Transform.scale(
                  scale: 1,
                  child: ElevatedButton(onPressed: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context) => ChatPage(senderID: _sender!.id,))); //id ini digunakn utk mengambil data user di tampilkan userList ChatPage
